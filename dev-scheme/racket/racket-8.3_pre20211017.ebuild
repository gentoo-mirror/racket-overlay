...
MAJOR="$(ver_cut 1-2)"  # 8.3_pre... => 8.3
PLT_V="${MAJOR}.0.2"    # 8.3        => 8.3.0.2
PLT_SNAP="20211017-601cab0"
PLT_HOST="https://www.cs.utah.edu/plt"
SRC_URI="
	minimal? ( ${PLT_HOST}/snapshots/${PLT_SNAP}/installers/racket-minimal-${PLT_V}-src-builtpkgs.tgz -> ${P}-minimal.tgz )
	!minimal? ( ${PLT_HOST}/snapshots/${PLT_SNAP}/installers/racket-${PLT_V}-src-builtpkgs.tgz -> ${P}.tgz )
"
